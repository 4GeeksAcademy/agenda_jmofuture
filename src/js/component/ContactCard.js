...
const ContactCard = ({ contact, onDelete }) => {
    ...
    const handleDelete = async () => {
        console.log("Intentando eliminar contacto:", contact.id);
        await onDelete(); 
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            ...
                            <p className="card-text"><strong><i className="fa-solid fa-location-dot"></i> Address:</strong> {contact.address}</p>
                            <p className="card-text"><strong><i className="fa-solid fa-phone"></i> Phone:</strong> {contact.phone}</p>
                            <p className="card-text"><i className="fa-solid fa-envelope"></i><strong> Email:</strong> {contact.email}</p>
                            <div className="d-flex gap-2 justify-content-end">
                                <button className="btn btn-primary" onClick={() => actions.openEditModal(contact)}>
